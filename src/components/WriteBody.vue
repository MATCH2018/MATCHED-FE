  ...
  methods: {
    ...
    write () {
      ...
      const data = {
        ...
        limitPeople: this.club_count
      }
      let url = ''; let url2 = ''
      if (this.Board1 === true) {
        url2 = '/Board/tutoring'
        url = 'http://ec2-13-124-173-243.ap-northeast-2.compute.amazonaws.com:8080/board/{boardName}'
        data.selectedcategory = this.selectedcategory
        data.selectedcategory2 = this.selectedcategory2
      }
      if (this.Board2 === true) {
        url2 = '/Board/club'
        url = 'http://ec2-13-124-173-243.ap-northeast-2.compute.amazonaws.com:8080/board/{boardName}'
        data.club_count = this.club_count
      }
      if (this.Board3 === true) {
        url2 = '/Board/capstone'
        url = 'http://ec2-13-124-173-243.ap-northeast-2.compute.amazonaws.com:8080/board/{boardName}'
