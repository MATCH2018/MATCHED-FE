            ...
            <tr>
              ...
              <div class="td-content">
                <ul>
                  <li>
                    <span class="chk-area">
                      <input type="radio" id="reason2" name="flag" value="2" checked>
                      <label for="reason2">욕설</label>
                    </span>
                  </li>
                  <li>
                    <span class="chk-area">
                      <input type="radio" id="reason1" name="flag" value="1">
                      <label for="reason1">광고</label>
                    </span>
                  </li>
                  <li>
                    <span class="chk-area">
                      <input type="radio" id="reason4" name="flag" value="4">
                      <label for="reason4">정치</label>
                    </span>
                  </li>
                  <li>
                    <span class="chk-area">
                      <input type="radio" id="reason3" name="flag" value="3">
...
export default {
  ...
  created () {
    ...
    const url = `http://localhost:3000/${this.BoardId}/${this.postId}`
    const url2 = 'http://localhost:3000/users/4'
    axios
      .get(url)
      .then((response) => {
